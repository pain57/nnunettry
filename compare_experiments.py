#!/usr/bin/env python3
"""Formal comparison of Exp 1–6 predictions (per-class Dice/Recall/clDice/HD95/ASSD).
...
HD95 / ASSD are in mm (real spacing from the ground-truth headers).
    ...
    python compare_experiments.py \
        ...
        --pred_dirs \
            ...
            exp4=predictions/exp4 \
            exp5=predictions/exp5 \
...
def main():
    ap = argparse.ArgumentParser(description="Compare Exp1-6 predictions")
    ap.add_argument("--gt_dir", required=True)
    ap.add_argument("--pred_dirs", nargs="+", required=True,
                    help="name=path pairs, e.g. exp1=predictions/exp1 exp5=predictions/exp5")
    args = ap.parse_args()
